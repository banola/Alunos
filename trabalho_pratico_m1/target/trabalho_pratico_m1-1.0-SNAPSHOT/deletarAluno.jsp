<%-- 
    ...
    Created on : 18 de set de 2024, 23:07:36
    Author     : rafha
--%>
...
<html>
    ...
    <body>
        ...
        <p class="highlight-text">O aluno foi removido do sistema.</p>
        <a class="btn btn-danger mt-3" href="/trabalho_pratico_m1/listarAlunos">Voltar para a lista de alunos</a>
        </div>
